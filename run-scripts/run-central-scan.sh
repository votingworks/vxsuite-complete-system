...
(trap 'kill 0' SIGINT SIGHUP; make -C vxsuite/services/smartcards run & make -C vxsuite/apps/central-scan/backend run & make -C vxsuite/apps/central-scan/frontend run) | logger --tag votingworksapp
