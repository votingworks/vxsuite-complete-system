...
(trap 'kill 0' SIGINT SIGHUP; make -C vxsuite/apps/scan/backend run & make -C vxsuite/services/smartcards run & make -C vxsuite/apps/scan/frontend run) | logger --tag votingworksapp
