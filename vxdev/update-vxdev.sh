...
ansible-playbook -i inventories/vxdev-latest playbooks/trusted_build/node.yaml
ansible-playbook -i inventories/vxdev-latest playbooks/trusted_build/rust.yaml
