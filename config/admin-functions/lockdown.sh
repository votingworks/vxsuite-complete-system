...
objcopy \
    ...
    --add-section .linux="/boot/vmlinuz-5.10.0-12-amd64" --change-section-vma .linux=0x2000000 \
    --add-section .initrd="/boot/initrd.img-5.10.0-12-amd64" --change-section-vma .initrd=0x3000000 \
