...
#---
# Remove packages via Ansible
# Note this does all the removals in one playbook run
# May need to ensure no issue with timing there
#---
# remove all network drivers. Buh bye.

sudo ansible-playbook playbooks/packages/remove_packages.yaml
